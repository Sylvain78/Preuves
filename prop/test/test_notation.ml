...
let add_chaining =
  ...
  in
  let verif = (print_endline "avant verif chaining";prop_proof_verif ~axioms:!axioms_prop ~theorems:!theorems_prop chaining ~proof:demo_chaining)          
  in
...
let add_idem =
  ...
  let verif = (prop_proof_verif ~axioms:!axioms_prop idem ~theorems:!theorems_prop ~proof:demo_idem)          
  in
  if verif then
    theorems_prop :=
      {
