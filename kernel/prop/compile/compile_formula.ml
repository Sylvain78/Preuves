include  Kernel_prop_interp.Formula_prop
  ...
  Dyp.update_pp (Kernel_prop_interp.Prop_parser.pp()) [
    Add_rules (List.map 
                 (function n ->
                    ...
                    and action _ l = Kernel_prop_interp.Prop_parser.Obj_formula1 (PApply_notation({apply_notation_prop = n;
                                                                                                apply_notation_prop_params = 
                                                                                                  List.filter_map  (function 
                                                                                                      |Kernel_prop_interp.Prop_parser.Obj_formula1 e -> Some e
                                                                                                      | _ -> None) l
                                                                                               })),
                                     []
                    in
