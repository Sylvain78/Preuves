...
let test_compile_s1 _ =
  ...
  and demo = compile_demonstration ~axioms:!axioms_prop ~theorems:!theorems_prop ~demo:((List.map (fun s -> Step (Kernel_prop_interp.Prop_parser.formula_from_string s)) [
